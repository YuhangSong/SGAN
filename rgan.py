...
def generate_image(iteration):
    ...
    if DOMAIN=='scalar':
        ...
        if FILTER_MODE!='none-f':
            ...
            log_img(F_out,'prediction-f',iteration)
            ...
            log_img(filtered_samples,'prediction-filtered',iteration)

            log_img(
                filtered_samples.mean(0),
                'prediction-filtered-mean',
                iteration
            )

...
'''domain settings'''
add_parameters(EXP = 'need_simple_prob')
...
if params['DOMAIN']=='1Dflip':
    ...
    add_parameters(GRID_ACTION_DISTRIBUTION = [1.0/3.0,2.0/3.0,0.0,0.0])
...
class Discriminator(nn.Module):
    ...
    def forward(self, state_v, prediction_v):
        ...
        state_v = state_v.contiguous().view(state_v.size()[0],-1)
        prediction_v = prediction_v.contiguous().view(prediction_v.size()[0],-1)

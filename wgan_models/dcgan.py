...
class DCGAN_D(nn.Module):
    ...
    def __init__(self, isize, nz, nc, ndf, ngpu, n_extra_layers=0):
        ...
        main.add_module('initial.conv_d.{0}-{1}'.format((config.gan_state_lenth+1)*nc, ndf),
                        nn.Conv2d((config.gan_state_lenth+1)*nc, ndf, 4, 2, 1, bias=False))
...
class DCGAN_C(nn.Module):
    ...
    def __init__(self, isize, nz, nc, ndf, ngpu, n_extra_layers=0):
        ...
        main.add_module('initial.conv_c.{0}-{1}'.format((config.gan_state_lenth+1)*nc, ndf),
                        nn.Conv2d((config.gan_state_lenth+1)*nc, ndf, 4, 2, 1, bias=False))
...
class DCGAN_G_Cv(nn.Module):
    ...
    def __init__(self, isize, nz, nc, ngf, ngpu, n_extra_layers=0):
        ...
        main.add_module('initial.conv_gc.{0}-{1}'.format(config.gan_state_lenth*nc, ngf),
                                               nn.Conv2d(config.gan_state_lenth*nc, ngf, 4, 2, 1, bias=False))
